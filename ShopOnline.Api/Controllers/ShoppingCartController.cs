    ...
    public class ShoppingCartController : ControllerBase
    {
        ...
        public async Task<ActionResult<CartItemDto>> PostItem([FromBody]CartItemToAddDto cartItemToAddDto)
        {
            try
            {
                ...
                if (product == null)
                {
                    throw new Exception($"Something went wrong when attempting to retrive product (productId:({newCartItem.ProductId}))");
                }
        ...
        [HttpPatch("{id:int}")]
        public async Task<ActionResult> UpdateQty(int id, CartItemQtyUpdateDto cartItemQtyUpdateDto)
        {
            try
            {
